...
namespace PortableDeviceConstants
{
    class PortableDevicePKeys
    {
        static PortableDevicePKeys()
        {
            ...
            WPD_OBJECT_SUPPORTED_UNITS.fmtid = new Guid( 0x0373CD3D, 0x4A46, 0x40D7, 0xB4, 0xD8, 0x73, 0xE8, 0xDA, 0x74, 0xE7, 0x75 );
            ...
            WPD_STILL_IMAGE_CAMERA_MODEL.fmtid = new Guid( 0x58C571EC, 0x1BCB, 0x42A7, 0x8A, 0xC5, 0xBB, 0x29, 0x15, 0x73, 0xA2, 0x60 );
            WPD_STILL_IMAGE_CAMERA_MODEL.pid = 30;

            WPD_STILL_IMAGE_CAMERA_MANUFACTURER.fmtid = new Guid( 0x58C571EC, 0x1BCB, 0x42A7, 0x8A, 0xC5, 0xBB, 0x29, 0x15, 0x73, 0xA2, 0x60 );
            ...
            WPD_CLIENT_MINIMUM_RESULTS_BUFFER_SIZE.fmtid = new Guid( 0x204D9F0C, 0x2292, 0x4080, 0x9F, 0x42, 0x40, 0x66, 0x4E, 0x70, 0xF8, 0x59 );
            WPD_CLIENT_MINIMUM_RESULTS_BUFFER_SIZE.pid = 12;

            WPD_CLIENT_MANUAL_CLOSE_ON_DISCONNECT.fmtid = new Guid( 0x204D9F0C, 0x2292, 0x4080, 0x9F, 0x42, 0x40, 0x66, 0x4E, 0x70, 0xF8, 0x59 );
            ...
            WPD_PROPERTY_ATTRIBUTE_NAME.fmtid = new Guid( 0x5D9DA160, 0x74AE, 0x43CC, 0x85, 0xA9, 0xFE, 0x55, 0x5A, 0x80, 0x79, 0x8E );
            WPD_PROPERTY_ATTRIBUTE_NAME.pid = 2;

            WPD_PROPERTY_ATTRIBUTE_VARTYPE.fmtid = new Guid( 0x5D9DA160, 0x74AE, 0x43CC, 0x85, 0xA9, 0xFE, 0x55, 0x5A, 0x80, 0x79, 0x8E );
            ...
            WPD_CLASS_EXTENSION_OPTIONS_MULTITRANSPORT_MODE.fmtid = new Guid( 0x3E3595DA, 0x4D71, 0x49FE, 0xA0, 0xB4, 0xD4, 0x40, 0x6C, 0x3A, 0xE9, 0x3F );
            WPD_CLASS_EXTENSION_OPTIONS_MULTITRANSPORT_MODE.pid = 2;

            WPD_CLASS_EXTENSION_OPTIONS_DEVICE_IDENTIFICATION_VALUES.fmtid = new Guid( 0x3E3595DA, 0x4D71, 0x49FE, 0xA0, 0xB4, 0xD4, 0x40, 0x6C, 0x3A, 0xE9, 0x3F );
            WPD_CLASS_EXTENSION_OPTIONS_DEVICE_IDENTIFICATION_VALUES.pid = 3;

            WPD_CLASS_EXTENSION_OPTIONS_TRANSPORT_BANDWIDTH.fmtid = new Guid( 0x3E3595DA, 0x4D71, 0x49FE, 0xA0, 0xB4, 0xD4, 0x40, 0x6C, 0x3A, 0xE9, 0x3F );
            WPD_CLASS_EXTENSION_OPTIONS_TRANSPORT_BANDWIDTH.pid = 4;

            WPD_CLASS_EXTENSION_OPTIONS_SILENCE_AUTOPLAY.fmtid = new Guid( 0x65C160F8, 0x1367, 0x4CE2, 0x93, 0x9D, 0x83, 0x10, 0x83, 0x9F, 0x0D, 0x30 );
            ...
            WPD_DEVICE_FUNCTIONAL_UNIQUE_ID.fmtid = new Guid( 0x463DD662, 0x7FC4, 0x4291, 0x91, 0x1C, 0x7F, 0x4C, 0x9C, 0xCA, 0x97, 0x99 );
            WPD_DEVICE_FUNCTIONAL_UNIQUE_ID.pid = 2;

            WPD_DEVICE_MODEL_UNIQUE_ID.fmtid = new Guid( 0x463DD662, 0x7FC4, 0x4291, 0x91, 0x1C, 0x7F, 0x4C, 0x9C, 0xCA, 0x97, 0x99 );
            WPD_DEVICE_MODEL_UNIQUE_ID.pid = 3;

            WPD_DEVICE_TRANSPORT.fmtid = new Guid( 0x463DD662, 0x7FC4, 0x4291, 0x91, 0x1C, 0x7F, 0x4C, 0x9C, 0xCA, 0x97, 0x99 );
            WPD_DEVICE_TRANSPORT.pid = 4;

            WPD_DEVICE_USE_DEVICE_STAGE.fmtid = new Guid( 0x463DD662, 0x7FC4, 0x4291, 0x91, 0x1C, 0x7F, 0x4C, 0x9C, 0xCA, 0x97, 0x99 );
            WPD_DEVICE_USE_DEVICE_STAGE.pid = 5;

            WPD_SERVICE_VERSION.fmtid = new Guid( 0x7510698A, 0xCB54, 0x481C, 0xB8, 0xDB, 0x0D, 0x75, 0xC9, 0x3F, 0x1C, 0x06 );
            ...
            WPD_EVENT_PARAMETER_SERVICE_METHOD_CONTEXT.fmtid = new Guid( 0x52807B8A, 0x4914, 0x4323, 0x9B, 0x9A, 0x74, 0xF6, 0x54, 0xB2, 0xB8, 0x46 );
            ...
            WPD_EVENT_ATTRIBUTE_NAME.fmtid = new Guid( 0x10C96578, 0x2E81, 0x4111, 0xAD, 0xDE, 0xE0, 0x8C, 0xA6, 0x13, 0x8F, 0x6D );
            WPD_EVENT_ATTRIBUTE_NAME.pid = 2;

            WPD_EVENT_ATTRIBUTE_PARAMETERS.fmtid = new Guid( 0x10C96578, 0x2E81, 0x4111, 0xAD, 0xDE, 0xE0, 0x8C, 0xA6, 0x13, 0x8F, 0x6D );
            WPD_EVENT_ATTRIBUTE_PARAMETERS.pid = 3;

            WPD_EVENT_ATTRIBUTE_OPTIONS.fmtid = new Guid( 0x10C96578, 0x2E81, 0x4111, 0xAD, 0xDE, 0xE0, 0x8C, 0xA6, 0x13, 0x8F, 0x6D );
            ...
            WPD_FORMAT_ATTRIBUTE_NAME.fmtid = new Guid( 0xA0A02000, 0xBCAF, 0x4BE8, 0xB3, 0xF5, 0x23, 0x3F, 0x23, 0x1C, 0xF5, 0x8F );
            WPD_FORMAT_ATTRIBUTE_NAME.pid = 2;

            WPD_FORMAT_ATTRIBUTE_MIMETYPE.fmtid = new Guid( 0xA0A02000, 0xBCAF, 0x4BE8, 0xB3, 0xF5, 0x23, 0x3F, 0x23, 0x1C, 0xF5, 0x8F );
            WPD_FORMAT_ATTRIBUTE_MIMETYPE.pid = 3;

            WPD_METHOD_ATTRIBUTE_NAME.fmtid = new Guid( 0xF17A5071, 0xF039, 0x44AF, 0x8E, 0xFE, 0x43, 0x2C, 0xF3, 0x2E, 0x43, 0x2A );
            WPD_METHOD_ATTRIBUTE_NAME.pid = 2;

            WPD_METHOD_ATTRIBUTE_ASSOCIATED_FORMAT.fmtid = new Guid( 0xF17A5071, 0xF039, 0x44AF, 0x8E, 0xFE, 0x43, 0x2C, 0xF3, 0x2E, 0x43, 0x2A );
            WPD_METHOD_ATTRIBUTE_ASSOCIATED_FORMAT.pid = 3;

            WPD_METHOD_ATTRIBUTE_ACCESS.fmtid = new Guid( 0xF17A5071, 0xF039, 0x44AF, 0x8E, 0xFE, 0x43, 0x2C, 0xF3, 0x2E, 0x43, 0x2A );
            WPD_METHOD_ATTRIBUTE_ACCESS.pid = 4;

            WPD_METHOD_ATTRIBUTE_PARAMETERS.fmtid = new Guid( 0xF17A5071, 0xF039, 0x44AF, 0x8E, 0xFE, 0x43, 0x2C, 0xF3, 0x2E, 0x43, 0x2A );
            WPD_METHOD_ATTRIBUTE_PARAMETERS.pid = 5;

            WPD_PARAMETER_ATTRIBUTE_ORDER.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_ORDER.pid = 2;

            WPD_PARAMETER_ATTRIBUTE_USAGE.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_USAGE.pid = 3;

            WPD_PARAMETER_ATTRIBUTE_FORM.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_FORM.pid = 4;

            WPD_PARAMETER_ATTRIBUTE_DEFAULT_VALUE.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_DEFAULT_VALUE.pid = 5;

            WPD_PARAMETER_ATTRIBUTE_RANGE_MIN.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_RANGE_MIN.pid = 6;

            WPD_PARAMETER_ATTRIBUTE_RANGE_MAX.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_RANGE_MAX.pid = 7;

            WPD_PARAMETER_ATTRIBUTE_RANGE_STEP.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_RANGE_STEP.pid = 8;

            WPD_PARAMETER_ATTRIBUTE_ENUMERATION_ELEMENTS.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_ENUMERATION_ELEMENTS.pid = 9;

            WPD_PARAMETER_ATTRIBUTE_REGULAR_EXPRESSION.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_REGULAR_EXPRESSION.pid = 10;

            WPD_PARAMETER_ATTRIBUTE_MAX_SIZE.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_MAX_SIZE.pid = 11;

            WPD_PARAMETER_ATTRIBUTE_VARTYPE.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            WPD_PARAMETER_ATTRIBUTE_VARTYPE.pid = 12;

            WPD_PARAMETER_ATTRIBUTE_NAME.fmtid = new Guid( 0xE6864DD7, 0xF325, 0x45EA, 0xA1, 0xD5, 0x97, 0xCF, 0x73, 0xB6, 0xCA, 0x58 );
            ...
            WPD_PROPERTY_COMMON_ACTIVITY_ID.fmtid = new Guid( 0xF0422A9C, 0x5DC8, 0x4440, 0xB5, 0xBD, 0x5D, 0xF2, 0x88, 0x35, 0x65, 0x8A );
            ...
            WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_DELETE_RESULTS.fmtid = new Guid( 0x9E5582E4, 0x0814, 0x44E6, 0x98, 0x1A, 0xB2, 0x99, 0x8D, 0x58, 0x38, 0x04 );
            ...
            WPD_COMMAND_OBJECT_RESOURCES_COMMIT.fmtid = new Guid( 0xB3A2B22D, 0xA595, 0x4108, 0xBE, 0x0A, 0xFC, 0x3C, 0x96, 0x5F, 0x3D, 0x4A );
            WPD_COMMAND_OBJECT_RESOURCES_COMMIT.pid = 12;

            WPD_COMMAND_OBJECT_RESOURCES_SEEK_IN_UNITS.fmtid = new Guid( 0xB3A2B22D, 0xA595, 0x4108, 0xBE, 0x0A, 0xFC, 0x3C, 0x96, 0x5F, 0x3D, 0x4A );
            ...
            WPD_PROPERTY_OBJECT_RESOURCES_SUPPORTS_UNITS.fmtid = new Guid( 0xB3A2B22D, 0xA595, 0x4108, 0xBE, 0x0A, 0xFC, 0x3C, 0x96, 0x5F, 0x3D, 0x4A );
            WPD_PROPERTY_OBJECT_RESOURCES_SUPPORTS_UNITS.pid = 1015;

            WPD_PROPERTY_OBJECT_RESOURCES_STREAM_UNITS.fmtid = new Guid( 0xB3A2B22D, 0xA595, 0x4108, 0xBE, 0x0A, 0xFC, 0x3C, 0x96, 0x5F, 0x3D, 0x4A );
            ...
            WPD_OPTION_OBJECT_RESOURCES_NO_INPUT_BUFFER_ON_READ.fmtid = new Guid( 0xB3A2B22D, 0xA595, 0x4108, 0xBE, 0x0A, 0xFC, 0x3C, 0x96, 0x5F, 0x3D, 0x4A );
            ...
            WPD_COMMAND_OBJECT_MANAGEMENT_UPDATE_OBJECT_WITH_PROPERTIES_AND_DATA.fmtid = new Guid( 0xEF1E43DD, 0xA9ED, 0x4341, 0x8B, 0xCC, 0x18, 0x61, 0x92, 0xAE, 0xA0, 0x89 );
            ...
            WPD_PROPERTY_OBJECT_MANAGEMENT_UPDATE_PROPERTIES.fmtid = new Guid( 0xEF1E43DD, 0xA9ED, 0x4341, 0x8B, 0xCC, 0x18, 0x61, 0x92, 0xAE, 0xA0, 0x89 );
            WPD_PROPERTY_OBJECT_MANAGEMENT_UPDATE_PROPERTIES.pid = 1014;

            WPD_PROPERTY_OBJECT_MANAGEMENT_PROPERTY_KEYS.fmtid = new Guid( 0xEF1E43DD, 0xA9ED, 0x4341, 0x8B, 0xCC, 0x18, 0x61, 0x92, 0xAE, 0xA0, 0x89 );
            WPD_PROPERTY_OBJECT_MANAGEMENT_PROPERTY_KEYS.pid = 1015;

            WPD_PROPERTY_OBJECT_MANAGEMENT_OBJECT_FORMAT.fmtid = new Guid( 0xEF1E43DD, 0xA9ED, 0x4341, 0x8B, 0xCC, 0x18, 0x61, 0x92, 0xAE, 0xA0, 0x89 );
            ...
            WPD_COMMAND_CLASS_EXTENSION_REGISTER_SERVICE_INTERFACES.fmtid = new Guid( 0x7F0779B5, 0xFA2B, 0x4766, 0x9C, 0xB2, 0xF7, 0x3B, 0xA3, 0x0B, 0x67, 0x58 );
            WPD_COMMAND_CLASS_EXTENSION_REGISTER_SERVICE_INTERFACES.pid = 2;

            WPD_COMMAND_CLASS_EXTENSION_UNREGISTER_SERVICE_INTERFACES.fmtid = new Guid( 0x7F0779B5, 0xFA2B, 0x4766, 0x9C, 0xB2, 0xF7, 0x3B, 0xA3, 0x0B, 0x67, 0x58 );
            WPD_COMMAND_CLASS_EXTENSION_UNREGISTER_SERVICE_INTERFACES.pid = 3;

            WPD_PROPERTY_CLASS_EXTENSION_SERVICE_OBJECT_ID.fmtid = new Guid( 0x7F0779B5, 0xFA2B, 0x4766, 0x9C, 0xB2, 0xF7, 0x3B, 0xA3, 0x0B, 0x67, 0x58 );
            WPD_PROPERTY_CLASS_EXTENSION_SERVICE_OBJECT_ID.pid = 1001;

            WPD_PROPERTY_CLASS_EXTENSION_SERVICE_INTERFACES.fmtid = new Guid( 0x7F0779B5, 0xFA2B, 0x4766, 0x9C, 0xB2, 0xF7, 0x3B, 0xA3, 0x0B, 0x67, 0x58 );
            WPD_PROPERTY_CLASS_EXTENSION_SERVICE_INTERFACES.pid = 1002;

            WPD_PROPERTY_CLASS_EXTENSION_SERVICE_REGISTRATION_RESULTS.fmtid = new Guid( 0x7F0779B5, 0xFA2B, 0x4766, 0x9C, 0xB2, 0xF7, 0x3B, 0xA3, 0x0B, 0x67, 0x58 );
            ...
            WPD_COMMAND_SERVICE_COMMON_GET_SERVICE_OBJECT_ID.fmtid = new Guid( 0x322F071D, 0x36EF, 0x477F, 0xB4, 0xB5, 0x6F, 0x52, 0xD7, 0x34, 0xBA, 0xEE );
            WPD_COMMAND_SERVICE_COMMON_GET_SERVICE_OBJECT_ID.pid = 2;

            WPD_PROPERTY_SERVICE_OBJECT_ID.fmtid = new Guid( 0x322F071D, 0x36EF, 0x477F, 0xB4, 0xB5, 0x6F, 0x52, 0xD7, 0x34, 0xBA, 0xEE );
            WPD_PROPERTY_SERVICE_OBJECT_ID.pid = 1001;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS.pid = 2;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS_BY_FORMAT.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS_BY_FORMAT.pid = 3;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_ATTRIBUTES.pid = 4;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_PARAMETER_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_PARAMETER_ATTRIBUTES.pid = 5;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMATS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMATS.pid = 6;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_ATTRIBUTES.pid = 7;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMAT_PROPERTIES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMAT_PROPERTIES.pid = 8;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_PROPERTY_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_PROPERTY_ATTRIBUTES.pid = 9;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_EVENTS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_EVENTS.pid = 10;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_ATTRIBUTES.pid = 11;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_PARAMETER_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_PARAMETER_ATTRIBUTES.pid = 12;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_INHERITED_SERVICES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_INHERITED_SERVICES.pid = 13;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_RENDERING_PROFILES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_RENDERING_PROFILES.pid = 14;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_COMMANDS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_COMMANDS.pid = 15;

            WPD_COMMAND_SERVICE_CAPABILITIES_GET_COMMAND_OPTIONS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_COMMAND_SERVICE_CAPABILITIES_GET_COMMAND_OPTIONS.pid = 16;

            WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_METHODS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_METHODS.pid = 1001;

            WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT.pid = 1002;

            WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD.pid = 1003;

            WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD_ATTRIBUTES.pid = 1004;

            WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER.pid = 1005;

            WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER_ATTRIBUTES.pid = 1006;

            WPD_PROPERTY_SERVICE_CAPABILITIES_FORMATS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_FORMATS.pid = 1007;

            WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT_ATTRIBUTES.pid = 1008;

            WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_KEYS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_KEYS.pid = 1009;

            WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_ATTRIBUTES.pid = 1010;

            WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_EVENTS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_EVENTS.pid = 1011;

            WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT.pid = 1012;

            WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT_ATTRIBUTES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT_ATTRIBUTES.pid = 1013;

            WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITANCE_TYPE.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITANCE_TYPE.pid = 1014;

            WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITED_SERVICES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITED_SERVICES.pid = 1015;

            WPD_PROPERTY_SERVICE_CAPABILITIES_RENDERING_PROFILES.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_RENDERING_PROFILES.pid = 1016;

            WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_COMMANDS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_COMMANDS.pid = 1017;

            WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND.pid = 1018;

            WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND_OPTIONS.fmtid = new Guid( 0x24457E74, 0x2E9F, 0x44F9, 0x8C, 0x57, 0x1D, 0x1B, 0xCB, 0x17, 0x0B, 0x89 );
            WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND_OPTIONS.pid = 1019;

            WPD_COMMAND_SERVICE_METHODS_START_INVOKE.fmtid = new Guid( 0x2D521CA8, 0xC1B0, 0x4268, 0xA3, 0x42, 0xCF, 0x19, 0x32, 0x15, 0x69, 0xBC );
            WPD_COMMAND_SERVICE_METHODS_START_INVOKE.pid = 2;

            WPD_COMMAND_SERVICE_METHODS_CANCEL_INVOKE.fmtid = new Guid( 0x2D521CA8, 0xC1B0, 0x4268, 0xA3, 0x42, 0xCF, 0x19, 0x32, 0x15, 0x69, 0xBC );
            WPD_COMMAND_SERVICE_METHODS_CANCEL_INVOKE.pid = 3;

            WPD_COMMAND_SERVICE_METHODS_END_INVOKE.fmtid = new Guid( 0x2D521CA8, 0xC1B0, 0x4268, 0xA3, 0x42, 0xCF, 0x19, 0x32, 0x15, 0x69, 0xBC );
            WPD_COMMAND_SERVICE_METHODS_END_INVOKE.pid = 4;

            WPD_PROPERTY_SERVICE_METHOD.fmtid = new Guid( 0x2D521CA8, 0xC1B0, 0x4268, 0xA3, 0x42, 0xCF, 0x19, 0x32, 0x15, 0x69, 0xBC );
            WPD_PROPERTY_SERVICE_METHOD.pid = 1001;

            WPD_PROPERTY_SERVICE_METHOD_PARAMETER_VALUES.fmtid = new Guid( 0x2D521CA8, 0xC1B0, 0x4268, 0xA3, 0x42, 0xCF, 0x19, 0x32, 0x15, 0x69, 0xBC );
            WPD_PROPERTY_SERVICE_METHOD_PARAMETER_VALUES.pid = 1002;

            WPD_PROPERTY_SERVICE_METHOD_RESULT_VALUES.fmtid = new Guid( 0x2D521CA8, 0xC1B0, 0x4268, 0xA3, 0x42, 0xCF, 0x19, 0x32, 0x15, 0x69, 0xBC );
            WPD_PROPERTY_SERVICE_METHOD_RESULT_VALUES.pid = 1003;

            WPD_PROPERTY_SERVICE_METHOD_CONTEXT.fmtid = new Guid( 0x2D521CA8, 0xC1B0, 0x4268, 0xA3, 0x42, 0xCF, 0x19, 0x32, 0x15, 0x69, 0xBC );
            WPD_PROPERTY_SERVICE_METHOD_CONTEXT.pid = 1004;

            WPD_PROPERTY_SERVICE_METHOD_HRESULT.fmtid = new Guid( 0x2D521CA8, 0xC1B0, 0x4268, 0xA3, 0x42, 0xCF, 0x19, 0x32, 0x15, 0x69, 0xBC );
            ...
            WPD_OBJECT_LANGUAGE_LOCALE.fmtid = new Guid( 0xEF6B490D, 0x5CD8, 0x437A, 0xAF, 0xFC, 0xDA, 0x8B, 0x60, 0xEE, 0x4A, 0x3C );
            ...
            WPD_IMAGE_HORIZONTAL_RESOLUTION.fmtid = new Guid( 0x63D64908, 0x9FA1, 0x479F, 0x85, 0xBA, 0x99, 0x52, 0x21, 0x64, 0x47, 0xDB );
            WPD_IMAGE_HORIZONTAL_RESOLUTION.pid = 9;

            WPD_IMAGE_VERTICAL_RESOLUTION.fmtid = new Guid( 0x63D64908, 0x9FA1, 0x479F, 0x85, 0xBA, 0x99, 0x52, 0x21, 0x64, 0x47, 0xDB );
            ...
            WPD_MEDIA_AUDIO_ENCODING_PROFILE.fmtid = new Guid( 0x2ED8BA05, 0x0AD3, 0x42DC, 0xB0, 0xD0, 0xBC, 0x95, 0xAC, 0x39, 0x6A, 0xC8 );
            ...
            WPD_CONTACT_RINGTONE.fmtid = new Guid( 0xFBD4FDAB, 0x987D, 0x4777, 0xB3, 0xF9, 0x72, 0x61, 0x85, 0xA9, 0x31, 0x2B );
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_OBJECT_SUPPORTED_UNITS;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_STILL_IMAGE_CAMERA_MODEL;
        public static PortableDeviceApiLib._tagpropertykey WPD_STILL_IMAGE_CAMERA_MANUFACTURER;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_CLIENT_MINIMUM_RESULTS_BUFFER_SIZE;
        public static PortableDeviceApiLib._tagpropertykey WPD_CLIENT_MANUAL_CLOSE_ON_DISCONNECT;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_ATTRIBUTE_NAME;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_ATTRIBUTE_VARTYPE;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_CLASS_EXTENSION_OPTIONS_MULTITRANSPORT_MODE;
        public static PortableDeviceApiLib._tagpropertykey WPD_CLASS_EXTENSION_OPTIONS_DEVICE_IDENTIFICATION_VALUES;
        public static PortableDeviceApiLib._tagpropertykey WPD_CLASS_EXTENSION_OPTIONS_TRANSPORT_BANDWIDTH;
        public static PortableDeviceApiLib._tagpropertykey WPD_CLASS_EXTENSION_OPTIONS_SILENCE_AUTOPLAY;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_DEVICE_FUNCTIONAL_UNIQUE_ID;
        public static PortableDeviceApiLib._tagpropertykey WPD_DEVICE_MODEL_UNIQUE_ID;
        public static PortableDeviceApiLib._tagpropertykey WPD_DEVICE_TRANSPORT;
        public static PortableDeviceApiLib._tagpropertykey WPD_DEVICE_USE_DEVICE_STAGE;
        public static PortableDeviceApiLib._tagpropertykey WPD_SERVICE_VERSION;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_EVENT_PARAMETER_SERVICE_METHOD_CONTEXT;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_EVENT_ATTRIBUTE_NAME;
        public static PortableDeviceApiLib._tagpropertykey WPD_EVENT_ATTRIBUTE_PARAMETERS;
        public static PortableDeviceApiLib._tagpropertykey WPD_EVENT_ATTRIBUTE_OPTIONS;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_FORMAT_ATTRIBUTE_NAME;
        public static PortableDeviceApiLib._tagpropertykey WPD_FORMAT_ATTRIBUTE_MIMETYPE;
        public static PortableDeviceApiLib._tagpropertykey WPD_METHOD_ATTRIBUTE_NAME;
        public static PortableDeviceApiLib._tagpropertykey WPD_METHOD_ATTRIBUTE_ASSOCIATED_FORMAT;
        public static PortableDeviceApiLib._tagpropertykey WPD_METHOD_ATTRIBUTE_ACCESS;
        public static PortableDeviceApiLib._tagpropertykey WPD_METHOD_ATTRIBUTE_PARAMETERS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_ORDER;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_USAGE;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_FORM;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_DEFAULT_VALUE;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_RANGE_MIN;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_RANGE_MAX;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_RANGE_STEP;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_ENUMERATION_ELEMENTS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_REGULAR_EXPRESSION;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_MAX_SIZE;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_VARTYPE;
        public static PortableDeviceApiLib._tagpropertykey WPD_PARAMETER_ATTRIBUTE_NAME;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_COMMON_ACTIVITY_ID;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_OBJECT_PROPERTIES_PROPERTY_DELETE_RESULTS;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_OBJECT_RESOURCES_COMMIT;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_OBJECT_RESOURCES_SEEK_IN_UNITS;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_OBJECT_RESOURCES_SUPPORTS_UNITS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_OBJECT_RESOURCES_STREAM_UNITS;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_OPTION_OBJECT_RESOURCES_NO_INPUT_BUFFER_ON_READ;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_OBJECT_MANAGEMENT_UPDATE_OBJECT_WITH_PROPERTIES_AND_DATA;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_OBJECT_MANAGEMENT_UPDATE_PROPERTIES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_OBJECT_MANAGEMENT_PROPERTY_KEYS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_OBJECT_MANAGEMENT_OBJECT_FORMAT;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_CLASS_EXTENSION_REGISTER_SERVICE_INTERFACES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_CLASS_EXTENSION_UNREGISTER_SERVICE_INTERFACES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_CLASS_EXTENSION_SERVICE_OBJECT_ID;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_CLASS_EXTENSION_SERVICE_INTERFACES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_CLASS_EXTENSION_SERVICE_REGISTRATION_RESULTS;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_COMMON_GET_SERVICE_OBJECT_ID;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_OBJECT_ID;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_METHODS_BY_FORMAT;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_METHOD_PARAMETER_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMATS;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_FORMAT_PROPERTIES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_PROPERTY_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_EVENTS;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_EVENT_PARAMETER_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_INHERITED_SERVICES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_FORMAT_RENDERING_PROFILES;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_SUPPORTED_COMMANDS;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_CAPABILITIES_GET_COMMAND_OPTIONS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_METHODS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_METHOD_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_PARAMETER_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_FORMATS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_FORMAT_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_KEYS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_PROPERTY_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_EVENTS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_EVENT_ATTRIBUTES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITANCE_TYPE;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_INHERITED_SERVICES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_RENDERING_PROFILES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_SUPPORTED_COMMANDS;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_CAPABILITIES_COMMAND_OPTIONS;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_METHODS_START_INVOKE;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_METHODS_CANCEL_INVOKE;
        public static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_SERVICE_METHODS_END_INVOKE;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_METHOD;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_METHOD_PARAMETER_VALUES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_METHOD_RESULT_VALUES;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_METHOD_CONTEXT;
        public static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_SERVICE_METHOD_HRESULT;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_OBJECT_LANGUAGE_LOCALE;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_IMAGE_HORIZONTAL_RESOLUTION;
        public static PortableDeviceApiLib._tagpropertykey WPD_IMAGE_VERTICAL_RESOLUTION;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_MEDIA_AUDIO_ENCODING_PROFILE;
        ...
        public static PortableDeviceApiLib._tagpropertykey WPD_CONTACT_RINGTONE;
...
class PortableDeviceGuids
{
        ...
        public static Guid WPD_EVENT_SERVICE_METHOD_COMPLETE = new Guid( 0x8A33F5F8, 0x0ACC, 0x4D9B, 0x9C, 0xC4, 0x11, 0x2D, 0x35, 0x3B, 0x86, 0xCA );
        ...
        public static Guid WPD_CONTENT_TYPE_TELEVISION = new Guid( 0x60A169CF, 0xF2AE, 0x4E21, 0x93, 0x75, 0x96, 0x77, 0xF1, 0x1C, 0x1C, 0x6E );
        ...
        public static Guid WPD_OBJECT_FORMAT_M4A = new Guid( 0x30ABA7AC, 0x6FFD, 0x4C23, 0xA3, 0x59, 0x3E, 0x9B, 0x52, 0xF3, 0xF1, 0xC8 );
        ...
        public static Guid WPD_OBJECT_FORMAT_3GPA = new Guid( 0xE5172730, 0xF971, 0x41EF, 0xA1, 0x0B, 0x22, 0x71, 0xA0, 0x01, 0x9D, 0x7A );
        public static Guid WPD_OBJECT_FORMAT_3G2A = new Guid( 0x1A11202D, 0x8759, 0x4E34, 0xBA, 0x5E, 0xB1, 0x21, 0x10, 0x87, 0xEE, 0xE4 );
        ...
        public static Guid WPD_OBJECT_FORMAT_WBMP = new Guid( 0xB8030000, 0xAE6C, 0x4804, 0x98, 0xBA, 0xC5, 0x7B, 0x46, 0x96, 0x5F, 0xE7 );
        public static Guid WPD_OBJECT_FORMAT_JPEGXR = new Guid( 0xB8040000, 0xAE6C, 0x4804, 0x98, 0xBA, 0xC5, 0x7B, 0x46, 0x96, 0x5F, 0xE7 );
        ...
        public static Guid WPD_OBJECT_FORMAT_ICALENDAR = new Guid( 0xBE030000, 0xAE6C, 0x4804, 0x98, 0xBA, 0xC5, 0x7B, 0x46, 0x96, 0x5F, 0xE7 );
        public static Guid WPD_OBJECT_FORMAT_ABSTRACT_CONTACT = new Guid( 0xBB810000, 0xAE6C, 0x4804, 0x98, 0xBA, 0xC5, 0x7B, 0x46, 0x96, 0x5F, 0xE7 );
        ...
        public static Guid WPD_OBJECT_FORMAT_QCELP = new Guid( 0xB9070000, 0xAE6C, 0x4804, 0x98, 0xBA, 0xC5, 0x7B, 0x46, 0x96, 0x5F, 0xE7 );
        public static Guid WPD_OBJECT_FORMAT_AMR = new Guid( 0xB9080000, 0xAE6C, 0x4804, 0x98, 0xBA, 0xC5, 0x7B, 0x46, 0x96, 0x5F, 0xE7 );
        ...
        public static Guid WPD_OBJECT_FORMAT_3G2 = new Guid( 0xB9850000, 0xAE6C, 0x4804, 0x98, 0xBA, 0xC5, 0x7B, 0x46, 0x96, 0x5F, 0xE7 );
        ...
        public static Guid WPD_OBJECT_FORMAT_MKV = new Guid( 0xB9900000, 0xAE6C, 0x4804, 0x98, 0xBA, 0xc5, 0x7B, 0x46, 0x96, 0x5F, 0xE7 );
} // class PortableDeviceGuids
} // namespace PortableDeviceConstants
